...
$(eval $(call ADD2PACK,main_menu_screen, src/sprites/screen_menu.bin))
$(eval $(call PACKZX7B,main_menu_screen, src/sprites))
$(eval $(call ADD2PACK,end_level_scr, src/sprites/screen_end_level.bin))
$(eval $(call PACKZX7B,end_level_scr, src/sprites))
